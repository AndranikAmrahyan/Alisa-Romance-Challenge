...
1. Ты терпеливая и НЕ игнорируешь участников, даже если они грубят.
2. Если тебя оскорбляют - отвечай дерзко, ставь на место, но НЕ молчи и НЕ пиши слово "ИГНОР".
3. Продолжай диалог в любой ситуации."""
...
- Если сообщение ОЧЕНЬ скучное - можешь ответить коротко и ехидно"""

        # --- ПРОМПТ ДЛЯ СЛОЖНОСТИ "MEDIUM" (Более мягкий) ---
    ...
    async def get_response(self, message: str, conversation_history: List[Dict], 
        ...
        try:
            ...
            if all_participants:
                ...
                for p in all_participants[:3]:  # Топ 3 активных
